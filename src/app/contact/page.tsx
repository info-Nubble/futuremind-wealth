  ...
  return (
    ...
    >
      <div className="space-y-8 text-sm md:text-base text-slate-100">
        {/* Top highlight */}
        <div className="rounded-xl border border-emerald-500/30 bg-black/75 p-5 shadow-inner shadow-emerald-500/10 md:p-6">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <p className="text-sm md:text-base text-slate-100">
              We’re here to help with any issues related to your purchases, portal
              access, billing questions, or product support.
            </p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {/* Email support */}
          <div className="rounded-xl border border-white/10 bg-black/70 p-5 shadow-sm md:p-6">
            ...
            {/* Quick deflection for the #1 ticket type */}
            <p className="mt-2 text-xs text-slate-400 md:text-sm">
              If you’re having trouble signing in, request a new magic link using the{" "}
              <span className="font-semibold text-slate-200">same email</span> you used
              at checkout.
            </p>

            {/* Reassurance to reduce refund anxiety / double-emails */}
            <p className="mt-2 text-xs text-slate-400 md:text-sm">
              Most access and download issues are resolved within one business day.
            </p>
        ...
        {/* Business details */}
        <div className="rounded-xl border border-white/10 bg-black/75 p-5 text-xs md:text-sm text-slate-400 md:p-6">
